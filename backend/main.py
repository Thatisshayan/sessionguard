...
# ── Pin the resolved Tesseract exe before any engine imports pytesseract ──────
...
from database.db import init_db, init_db_v2, init_db_v3, init_db_v4, init_db_v5, init_db_v6, init_db_v7, init_db_v8, init_db_v9, init_db_v10, init_db_v11, init_db_v12, init_db_v13, init_db_v14, seed_demo_data, seed_demo_user
...
def on_startup():
    ...
    seed_demo_user()
    init_db_v12(); init_db_v13(); init_db_v14()
